...
<head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="views/Librerias/alertify/themes/alertify.core.css"> -->
	<!-- <link rel="stylesheet" type="text/css" href="views/Librerias/alertify/themes/alertify.default.css"> -->


	<!-- ***************************************JS************************************* -->

	<!-- <script type="text/javascript" src="views/Librerias/alertify/lib/alertify.js"></script> -->
...
<body>
	    ...
	    <div id="contenedor" class="contenedor-tapar">
			<center><div class="titulo-tabla">AULAS - AUTOMÁTICO</div></center>
	...
	<script type="text/javascript">
		...
		function CrearTabla(filas,columnas,hora){
			...
			horainicial=hora;
			$("#tabla-docentes").append("<tr><td colspan='6' class='cabecera-tabla ca'>"+titulo+
